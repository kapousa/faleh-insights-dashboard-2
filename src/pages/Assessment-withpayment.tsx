                ...
                {screen === "payment" && (
                    <motion.div className="text-center p-10">
                        ...
                        <p className="text-white/60 mb-8">
                            You will be redirected to our secure payment page. Once payment is confirmed,
                            your report will be generated.
                        </p>

                        <a
                            href="https://buy.stripe.com/3cIbJ05Vhbcs2RNgIS0oM00"
                            target="_blank"
                            rel="noopener noreferrer"
                            onClick={() => {
                                // Optional: Trigger a "Wait for payment" state or logic
                                setScreen("confirm"); // Immediately show confirm screen assuming redirect
                            }}
                            className="bg-brand-gold text-brand-navy px-8 py-4 rounded-lg font-bold"
                        >
                            Pay AED 3,500 via Stripe
                        </a>
                    </motion.div>
                )}
